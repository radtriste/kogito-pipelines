...
* [kogito-native](https://github.com/kiegroup/kogito-runtimes/blob/master/.ci/jenkins/Jenkinsfile.native)  
  Perform a daily native build&test of runtimes.
* [kogito-quarkus](https://github.com/kiegroup/kogito-runtimes/blob/master/.ci/jenkins/Jenkinsfile.quarkus)  
  Perform a daily check of runtimes against latest snapshot of Quarkus.
* [kogito-drools-snapshot](https://github.com/kiegroup/kogito-runtimes/blob/master/.ci/jenkins/Jenkinsfile.drools)  
